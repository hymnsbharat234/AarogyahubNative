...
const SomeOnElse =  ({phone,address,name,slotindex,dayindex,id,did,navigation,date, start}) => {
  ...
  const onSubmit = data => {
    ...
    navigation.navigate("SelectPaymentPage",{...data,slotindex,dayindex,id,did,type:'other',date,start})
